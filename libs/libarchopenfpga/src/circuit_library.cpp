 ...
 * Constructors
 ***********************************************************************/
CircuitLibrary::CircuitLibrary() { return; }
...
/* Find circuit models in the same type (defined by users) and return a list of
 * ids */
std::vector<CircuitModelId> CircuitLibrary::models_by_type(
...
size_t CircuitLibrary::num_models() const { return model_ids_.size(); }

/* Access the type of a circuit model */
enum e_circuit_model_type CircuitLibrary::model_type(
...
std::string CircuitLibrary::model_verilog_netlist(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
...
std::string CircuitLibrary::model_spice_netlist(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
...
/* Access the is_default flag (check if this is the default circuit model in the
 * type) of a circuit model */
...
bool CircuitLibrary::dump_structural_verilog(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
...
bool CircuitLibrary::dump_explicit_port_map(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
...
enum e_circuit_model_design_tech CircuitLibrary::design_tech_type(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
...
std::string CircuitLibrary::device_model_name(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
...
/* Return a flag showing if intermediate stages of a LUT are buffered for a
 * circuit model */
bool CircuitLibrary::is_lut_intermediate_buffered(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
 ...
 */
CircuitModelId CircuitLibrary::lut_input_inverter_model(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
 ...
 * that are inserted between multiplexing structure and LUT inputs
 */
CircuitModelId CircuitLibrary::lut_input_buffer_model(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
  /* validate the circuit model type is BUF */
 ...
 */
CircuitModelId CircuitLibrary::lut_intermediate_buffer_model(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
  /* validate the circuit model type is BUF */
  VTR_ASSERT(CIRCUIT_MODEL_LUT == model_type(model_id));
  /* if we have an intermediate buffer, we return something, otherwise return an
   * invalid id */
 ...
 * that are inserted inside LUT multiplexing structures
 */
std::string CircuitLibrary::lut_intermediate_buffer_location_map(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
  /* validate the circuit model type is BUF */
 ...
 */
CircuitModelId CircuitLibrary::pass_gate_logic_model(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
 ...
 * circuit model and go recursively
 */
std::string CircuitLibrary::pass_gate_logic_model_name(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
...
/* Return the pmos size of a pass gate logic module, only applicable to circuit
 * model whose type is pass-gate logic */
float CircuitLibrary::pass_gate_logic_pmos_size(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
...
/* Return the nmos size of a pass gate logic module, only applicable to circuit
 * model whose type is pass-gate logic */
float CircuitLibrary::pass_gate_logic_nmos_size(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
  /* validate that the type of this model should be PASSGATE */
...
enum e_circuit_model_structure CircuitLibrary::mux_structure(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
 ...
 * Only applicable for MUX/LUT circuit model
 */
size_t CircuitLibrary::mux_const_input_value(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
  /* validate the circuit model type is MUX */
 ...
 * Only applicable for MUX/LUT circuit model
 */
bool CircuitLibrary::mux_use_local_encoder(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
  /* validate the circuit model type is MUX */
 ...
 * Only applicable for MUX/LUT circuit model
 */
bool CircuitLibrary::mux_use_advanced_rram_design(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
  /* validate the circuit model type is MUX */
 ...
 */
enum e_circuit_model_gate_type CircuitLibrary::gate_type(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
  /* validate the circuit model type is MUX */
 ...
 */
enum e_circuit_model_buffer_type CircuitLibrary::buffer_type(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
  /* validate the circuit model type is MUX */
 ...
 * Only applicable for BUF/INV circuit model
 */
size_t CircuitLibrary::buffer_f_per_stage(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
  /* validate the circuit model type is BUF */
...
CircuitModelId CircuitLibrary::input_buffer_model(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
...
CircuitModelId CircuitLibrary::output_buffer_model(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
...
/* Return the type of a wire model, this is ONLY applicable to wires and channel
 * wires */
e_wire_model_type CircuitLibrary::wire_type(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
...
float CircuitLibrary::rram_wprog_set_pmos(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
  /* validate that the design_tech of this model should be RRAM */
...
float CircuitLibrary::rram_wprog_set_nmos(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
  /* validate that the design_tech of this model should be RRAM */
...
float CircuitLibrary::rram_wprog_reset_pmos(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
  /* validate that the design_tech of this model should be RRAM */
...
float CircuitLibrary::rram_wprog_reset_nmos(
  const CircuitModelId& model_id) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
  /* validate that the design_tech of this model should be RRAM */
...
CircuitPortId CircuitLibrary::model_port(const CircuitModelId& model_id,
 ...
 * when counting
 */
size_t CircuitLibrary::num_model_ports_by_type(
  ...
  for (auto port : model_port_lookup_[model_id][port_type]) {
    ...
    if ((false == include_global_port) && (true == port_is_global(port))) {
      continue;
    }
    num_ports++;
  }
...
std::vector<CircuitPortId> CircuitLibrary::model_ports(
  const CircuitModelId& model_id) const {
...
/* Recursively find all the global ports in the circuit model / sub
 * circuit_model */
std::vector<CircuitPortId> CircuitLibrary::model_global_ports(
  const CircuitModelId& model_id, const bool& recursive) const {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
  ...
  for (const auto& sub_model : sub_models_[model_id]) {
    std::vector<CircuitPortId> sub_global_ports =
      model_global_ports(sub_model, recursive);
    for (const auto& sub_global_port : sub_global_ports) {
      ...
      for (const auto& global_port : global_ports) {
        if (0 ==
            port_prefix(sub_global_port).compare(port_prefix(global_port))) {
...
/* Recursively find all the global ports in the circuit model / sub
 * circuit_model */
std::vector<CircuitPortId> CircuitLibrary::model_global_ports_by_type(
  ...
  for (const auto& sub_model : sub_models_[model_id]) {
    ...
    std::vector<CircuitPortId> sub_global_ports = model_global_ports_by_type(
      sub_model, type, recursive, ignore_model_types);
    for (const auto& sub_global_port : sub_global_ports) {
      /* Add to global_ports, if it is not already found in the list */
      bool add_to_list = true;
      for (const auto& global_port : global_ports) {
...
/* Recursively find all the global ports in the circuit model / sub
 * circuit_model whose port type matches users' specification
 */
std::vector<CircuitPortId> CircuitLibrary::model_global_ports_by_type(
  const CircuitModelId& model_id,
  ...
  for (const auto& port_type : types) {
    std::vector<CircuitPortId> global_port_by_type = model_global_ports_by_type(
      model_id, port_type, recursive, ignore_config_memories);
    /* Insert the vector to the final global_ports */
    global_ports.insert(global_ports.begin(), global_port_by_type.begin(),
                        global_port_by_type.end());
  }
  return global_ports;
}

/* Recursively find all the global ports in the circuit model / sub
 * circuit_model but ignore all the SRAM and CCFF, which are configuration
 * memories
 */
std::vector<CircuitPortId> CircuitLibrary::model_global_ports_by_type(
  const CircuitModelId& model_id, const enum e_circuit_model_port_type& type,
...
/* Find the ports of a circuit model by a given type, return a list of qualified
 * ports */
std::vector<CircuitPortId> CircuitLibrary::model_ports_by_type(
  const CircuitModelId& model_id,
...
/* Find the ports of a circuit model by a given type, return a list of qualified
 * ports with an option to include/exclude global ports
 */
std::vector<CircuitPortId> CircuitLibrary::model_ports_by_type(
  const CircuitModelId& model_id, const enum e_circuit_model_port_type& type,
  ...
  for (const auto& port_id : model_port_lookup_[model_id][type]) {
    ...
    if ((true == ignore_global_port) && (true == port_is_global(port_id))) {
      continue;
    }
    port_ids.push_back(port_id);
  }
 ...
 */
std::vector<CircuitPortId> CircuitLibrary::model_input_ports(
  const CircuitModelId& model_id) const {
 ...
 */
std::vector<CircuitPortId> CircuitLibrary::model_output_ports(
  const CircuitModelId& model_id) const {
 ...
 */
std::vector<size_t> CircuitLibrary::pins(
...
bool CircuitLibrary::is_output_port(
  const CircuitPortId& circuit_port_id) const {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
  /* Only CIRCUIT_MODEL_OUTPUT AND INOUT are considered as outputs */
...
/* Access the type of a port of a circuit model */
enum e_circuit_model_port_type CircuitLibrary::port_type(
  const CircuitPortId& circuit_port_id) const {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
std::string CircuitLibrary::port_prefix(
  const CircuitPortId& circuit_port_id) const {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
std::string CircuitLibrary::port_lib_name(
  const CircuitPortId& circuit_port_id) const {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
std::string CircuitLibrary::port_inv_prefix(
  const CircuitPortId& circuit_port_id) const {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
size_t CircuitLibrary::port_default_value(
  const CircuitPortId& circuit_port_id) const {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
/* Return a flag if the port is used in mode-selection purpuse of a circuit
 * model */
bool CircuitLibrary::port_is_data_io(
  const CircuitPortId& circuit_port_id) const {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
bool CircuitLibrary::port_is_global(
  const CircuitPortId& circuit_port_id) const {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
bool CircuitLibrary::port_is_config_enable(
  const CircuitPortId& circuit_port_id) const {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
/* Return a flag if the port is used during programming a FPGA in a circuit
 * model */
...
bool CircuitLibrary::port_is_shift_register(
  const CircuitPortId& circuit_port_id) const {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
size_t CircuitLibrary::port_lut_frac_level(
  const CircuitPortId& circuit_port_id) const {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
bool CircuitLibrary::port_is_harden_lut_port(
  const CircuitPortId& circuit_port_id) const {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
/* Return indices of internal nodes in a LUT multiplexing structure to which the
 * output port is wired to */
std::vector<size_t> CircuitLibrary::port_lut_output_mask(
  const CircuitPortId& circuit_port_id) const {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
std::string CircuitLibrary::port_tri_state_map(
  const CircuitPortId& circuit_port_id) const {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
CircuitModelId CircuitLibrary::port_tri_state_model(
  const CircuitPortId& circuit_port_id) const {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
std::string CircuitLibrary::port_tri_state_model_name(
  const CircuitPortId& circuit_port_id) const {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
CircuitModelId CircuitLibrary::port_parent_model(
  const CircuitPortId& circuit_port_id) const {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
std::string CircuitLibrary::port_inv_model_name(
  const CircuitPortId& circuit_port_id) const {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
std::vector<CircuitEdgeId> CircuitLibrary::timing_edges_by_model(
  const CircuitModelId& model_id) const {
...
CircuitPortId CircuitLibrary::timing_edge_src_port(
  const CircuitEdgeId& edge) const {
...
CircuitPortId CircuitLibrary::timing_edge_sink_port(
  const CircuitEdgeId& edge) const {
  /* Validate the edge id */
  VTR_ASSERT_SAFE(valid_edge_id(edge));
...
float CircuitLibrary::timing_edge_delay(
...
CircuitModelId CircuitLibrary::default_model(
  const enum e_circuit_model_type& type) const {
 ...
 ***********************************************************************/
/* Given the source and sink port information, find the edge connecting the two
 * ports */
CircuitEdgeId CircuitLibrary::edge(const CircuitPortId& from_port,
                                   const size_t from_pin,
                                   const CircuitPortId& to_port,
                                   const size_t to_pin) {
...
CircuitModelId CircuitLibrary::add_model(
  const enum e_circuit_model_type& type) {
  /* Create a new id*/
...
void CircuitLibrary::set_model_name(const CircuitModelId& model_id,
...
void CircuitLibrary::set_model_prefix(const CircuitModelId& model_id,
...
void CircuitLibrary::set_model_verilog_netlist(
  const CircuitModelId& model_id, const std::string& verilog_netlist) {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
...
void CircuitLibrary::set_model_spice_netlist(const CircuitModelId& model_id,
...
void CircuitLibrary::set_model_is_default(const CircuitModelId& model_id,
...
void CircuitLibrary::set_model_dump_structural_verilog(
  const CircuitModelId& model_id, const bool& dump_structural_verilog) {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
...
void CircuitLibrary::set_model_dump_explicit_port_map(
  const CircuitModelId& model_id, const bool& dump_explicit_port_map) {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
...
void CircuitLibrary::set_model_design_tech_type(
  const CircuitModelId& model_id,
...
void CircuitLibrary::set_model_is_power_gated(const CircuitModelId& model_id,
...
void CircuitLibrary::set_device_model_name(const CircuitModelId& model_id,
                                           const std::string& name) {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
...
/* Set input inverter information for the circuit model, only applicable to
 * LUTs! */
void CircuitLibrary::set_model_lut_input_inverter(
  const CircuitModelId& model_id, const bool& existence,
  const std::string& model_name) {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
  /* Make sure the circuit model is a LUT! */
...
/* Set intermediate buffer information for the circuit model, only applicable to
 * LUTs! */
...
void CircuitLibrary::set_model_lut_intermediate_buffer_location_map(
...
void CircuitLibrary::set_model_pass_gate_logic(const CircuitModelId& model_id,
                                               const std::string& model_name) {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
...
void CircuitLibrary::set_port_default_value(
  const CircuitPortId& circuit_port_id, const size_t& default_value) {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
/* Set the is_mode_select for a port of a circuit model */
void CircuitLibrary::set_port_is_mode_select(
  const CircuitPortId& circuit_port_id, const bool& is_mode_select) {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
void CircuitLibrary::set_port_is_config_enable(
  const CircuitPortId& circuit_port_id, const bool& is_config_enable) {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
/* Set the is_prog for a port of a circuit model */
void CircuitLibrary::set_port_is_shift_register(
  const CircuitPortId& circuit_port_id, const bool& is_shift_register) {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
void CircuitLibrary::set_port_tri_state_model_name(
...
void CircuitLibrary::set_port_tri_state_model_id(
  const CircuitPortId& circuit_port_id, const CircuitModelId& port_model_id) {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
void CircuitLibrary::set_port_inv_model_name(
  const CircuitPortId& circuit_port_id, const std::string& inv_model_name) {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
void CircuitLibrary::set_port_tri_state_map(
  const CircuitPortId& circuit_port_id, const std::string& tri_state_map) {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
/* Set the LUT fracturable level for a port of a circuit model, only applicable
 * to LUTs */
void CircuitLibrary::set_port_lut_frac_level(
  const CircuitPortId& circuit_port_id, const size_t& lut_frac_level) {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
...
/* Set the LUT fracturable level for a port of a circuit model, only applicable
 * to LUTs */
void CircuitLibrary::set_port_is_harden_lut_port(
  const CircuitPortId& circuit_port_id, const bool& is_harden_lut_port) {
  /* validate the circuit_port_id */
  VTR_ASSERT(valid_circuit_port_id(circuit_port_id));
  /* Make sure this is a LUT */
  VTR_ASSERT(CIRCUIT_MODEL_LUT == model_type(port_model_ids_[circuit_port_id]));
...
/* Set the LUT fracturable level for a port of a circuit model, only applicable
 * to LUTs */
void CircuitLibrary::set_port_lut_output_mask(
...
/* Set the SRAM organization for a port of a circuit model, only applicable to
 * SRAM ports */
void CircuitLibrary::set_port_sram_orgz(
  const CircuitPortId& circuit_port_id,
 ...
 */
void CircuitLibrary::add_delay_info(
  const CircuitModelId& model_id,
...
void CircuitLibrary::set_delay_in_port_names(
  const CircuitModelId& model_id,
  const enum e_circuit_model_delay_type& delay_type,
...
void CircuitLibrary::set_delay_out_port_names(
  const CircuitModelId& model_id,
  const enum e_circuit_model_delay_type& delay_type,
...
void CircuitLibrary::set_delay_values(
  const CircuitModelId& model_id,
  const enum e_circuit_model_delay_type& delay_type,
...
/* Buffer/Inverter-related parameters */
void CircuitLibrary::set_buffer_type(
  const CircuitModelId& model_id,
...
/* Pass-gate-related parameters */
void CircuitLibrary::set_pass_gate_logic_type(
  const CircuitModelId& model_id,
...
void CircuitLibrary::set_pass_gate_logic_nmos_size(
  const CircuitModelId& model_id, const float& nmos_size) {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
  /* validate that the type of this model should be BUFFER or INVERTER */
  VTR_ASSERT(CIRCUIT_MODEL_PASSGATE == model_type(model_id));
...
void CircuitLibrary::set_pass_gate_logic_pmos_size(
  const CircuitModelId& model_id, const float& pmos_size) {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
  /* validate that the type of this model should be BUFFER or INVERTER */
  VTR_ASSERT(CIRCUIT_MODEL_PASSGATE == model_type(model_id));
...
/* Multiplexer-related parameters */
void CircuitLibrary::set_mux_structure(
  const CircuitModelId& model_id,
...
void CircuitLibrary::set_mux_const_input_value(
  const CircuitModelId& model_id, const size_t& const_input_value) {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
  /* validate that the type of this model should be MUX or LUT */
  VTR_ASSERT((CIRCUIT_MODEL_MUX == model_type(model_id)) ||
...
void CircuitLibrary::set_mux_use_advanced_rram_design(
  const CircuitModelId& model_id, const bool& use_advanced_rram_design) {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
  /* validate that the type of this model should be MUX or LUT */
  VTR_ASSERT((CIRCUIT_MODEL_MUX == model_type(model_id)) ||
...
/* Gate-related parameters */
void CircuitLibrary::set_gate_type(
  const CircuitModelId& model_id,
 ...
 */
void CircuitLibrary::set_model_buffer(const CircuitModelId& model_id,
  ...
  buffer_model_ids_[model_id][size_t(buffer_type)] =
    CircuitModelId::INVALID(); /* Set an OPEN id here, which will be linked
                                  later */
  return;
}
...
void CircuitLibrary::link_port_tri_state_model() {
  /* Walk through each ports, get the port id and find the circuit model id by
   * name */
  for (auto& port_id : ports()) {
    ...
    port_tri_state_model_ids_[port_id] =
      model(port_tri_state_model_names_[port_id]);
  }
  return;
}
...
void CircuitLibrary::link_buffer_model(const CircuitModelId& model_id) {
  ...
  for (size_t buffer_id = 0; buffer_id < buffer_model_names_[model_id].size();
       ++buffer_id) {
 ...
 * configure the buffer_model_id
 */
void CircuitLibrary::link_pass_gate_logic_model(
  const CircuitModelId& model_id) {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
  /* Get the circuit model id by name, skip those with empty names*/
...
bool CircuitLibrary::is_unique_submodel(const CircuitModelId& model_id,
                                        const CircuitModelId& submodel_id) {
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
  VTR_ASSERT(valid_model_id(submodel_id));

  std::vector<CircuitModelId>::iterator it = std::find(
    sub_models_[model_id].begin(), sub_models_[model_id].end(), submodel_id);
...
void CircuitLibrary::auto_detect_default_models() {
  ...
  for (const auto& curr_type_models : model_lookup_) {
    if ((1 == curr_type_models.size()) &&
      ...
      VTR_LOG_WARN(
        "Automatically set circuit model '%s' to be default in its type.\n",
...
void CircuitLibrary::set_edge_delay(
  const CircuitModelId& model_id, const CircuitEdgeId& circuit_edge_id,
  const enum e_circuit_model_delay_type& delay_type, const float& delay_value) {
...
void CircuitLibrary::set_timing_graph_delays(const CircuitModelId& model_id) {
  ...
  for (const auto& delay_type : delay_types_[model_id]) {
    ...
    openfpga::MultiPortParser input_port_parser(
      delay_in_port_names_[model_id][size_t(delay_type)]);
    ...
    for (auto& port_info : input_ports) {
      ...
      if (0 == port_info.get_width()) {
         ...
         * This means that parser find some compact port defintion such as
         * <port_name>
         */
    ...
    openfpga::MultiPortParser output_port_parser(
      delay_out_port_names_[model_id][size_t(delay_type)]);
    ...
    openfpga::PortDelayParser port_delay_parser(
      delay_values_[model_id][size_t(delay_type)]);
    ...
    for (size_t i = 0; i < port_delay_parser.height(); ++i) {
      for (size_t j = 0; j < port_delay_parser.width(); ++j) {
        ...
        set_edge_delay(model_id, edge_id, delay_type, delay_value);
      }
    }
  }
  return;
...
void CircuitLibrary::build_model_lookup() {
  ...
  for (auto& type : model_lookup_) {
    ...
    for (size_t id = 0; id < type.size(); ++id) {
      ...
      /* Once we find a default model, swap with the first element and finish
       * the loop */
...
bool CircuitLibrary::valid_circuit_port_id(
  const CircuitPortId& circuit_port_id) const {
  return (size_t(circuit_port_id) < port_ids_.size()) &&
         (circuit_port_id == port_ids_[circuit_port_id]);
}

bool CircuitLibrary::valid_circuit_pin_id(const CircuitPortId& circuit_port_id,
...
bool CircuitLibrary::valid_delay_type(
  ...
  /* validate the model_id */
  VTR_ASSERT(valid_model_id(model_id));
  return (size_t(delay_type) < delay_types_[model_id].size()) &&
         (delay_type == delay_types_[model_id][size_t(delay_type)]);
}

bool CircuitLibrary::valid_circuit_edge_id(
  const CircuitEdgeId& circuit_edge_id) const {
  return (size_t(circuit_edge_id) < edge_ids_.size()) &&
         (circuit_edge_id == edge_ids_[circuit_edge_id]);
}
 ...
 * Others are invalid
 */
bool CircuitLibrary::valid_mux_const_input_value(
  const size_t& const_input_value) const {
  return ((size_t(-1) == const_input_value) || (0 == const_input_value) ||
          (1 == const_input_value));
}
