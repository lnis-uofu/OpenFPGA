...
Through this tutorial, we will show how and when to use the :ref:`user_defined_templates.v` file.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
The :ref:`user_defined_templates.v` file can be found starting from the root directory and entering:
