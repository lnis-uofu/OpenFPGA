...
run_openfpga_command "\
vpr ${OPENFPGA_PATH}/openfpga_flow/vpr_arch/k4_frac_N4_tileable_40nm_custrrg.xml ${OPENFPGA_PATH}/openfpga_flow/benchmarks/micro_benchmark/and2/and2.blif --device FPGA44_CUSTOM_GRAPH --route_chan_width 100" | tee vpr_stdout1.log
...
show_vpr_setup;pack --verbose;" | tee vpr_stdout.log