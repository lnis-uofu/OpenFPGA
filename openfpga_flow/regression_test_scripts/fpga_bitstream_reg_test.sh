...
echo -e "Testing bitstream generation for fixed atom block location through vpr contraints";
run-task fpga_bitstream/fix_atom_loc $@
...
run-task fpga_bitstream/unused_mux_input $@
