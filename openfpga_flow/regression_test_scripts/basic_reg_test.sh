...
# Comment out as this feature is not working fine actually. Need a revisit in future
...
run-task basic_tests/clock_network/homo_1clock_1reset_2layer_ckbuf_intermediate_driver $@
