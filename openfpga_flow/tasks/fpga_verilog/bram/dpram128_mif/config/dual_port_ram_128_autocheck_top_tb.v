...
// ----- Error counter: Deposit an error for config_done signal is not raised at the beginning -----
	integer nb_error= 1;
// ----- Number of clock cycles in configuration phase: 6515 -----
...
// ----- Blif Benchmark input wen is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[29] -----
	assign gfpga_pad_GPIO_PAD[29] = wen_shared_input[0];

// ----- Blif Benchmark input ren is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[52] -----
	assign gfpga_pad_GPIO_PAD[52] = ren_shared_input[0];

// ----- Blif Benchmark input waddr_0_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[28] -----
	assign gfpga_pad_GPIO_PAD[28] = waddr_0__shared_input[0];

// ----- Blif Benchmark input waddr_1_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[24] -----
	assign gfpga_pad_GPIO_PAD[24] = waddr_1__shared_input[0];

// ----- Blif Benchmark input waddr_2_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[31] -----
	assign gfpga_pad_GPIO_PAD[31] = waddr_2__shared_input[0];

// ----- Blif Benchmark input raddr_0_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[48] -----
	assign gfpga_pad_GPIO_PAD[48] = raddr_0__shared_input[0];

// ----- Blif Benchmark input raddr_1_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[55] -----
	assign gfpga_pad_GPIO_PAD[55] = raddr_1__shared_input[0];

// ----- Blif Benchmark input raddr_2_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[73] -----
	assign gfpga_pad_GPIO_PAD[73] = raddr_2__shared_input[0];

// ----- Blif Benchmark input din_0_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[15] -----
	assign gfpga_pad_GPIO_PAD[15] = din_0__shared_input[0];

// ----- Blif Benchmark input din_1_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[78] -----
	assign gfpga_pad_GPIO_PAD[78] = din_1__shared_input[0];

// ----- Blif Benchmark input din_2_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[54] -----
	assign gfpga_pad_GPIO_PAD[54] = din_2__shared_input[0];

// ----- Blif Benchmark input din_3_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[11] -----
	assign gfpga_pad_GPIO_PAD[11] = din_3__shared_input[0];

// ----- Blif Benchmark input din_4_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[26] -----
	assign gfpga_pad_GPIO_PAD[26] = din_4__shared_input[0];

// ----- Blif Benchmark input din_5_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[42] -----
	assign gfpga_pad_GPIO_PAD[42] = din_5__shared_input[0];

// ----- Blif Benchmark input din_6_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[50] -----
	assign gfpga_pad_GPIO_PAD[50] = din_6__shared_input[0];

// ----- Blif Benchmark input din_7_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[27] -----
	assign gfpga_pad_GPIO_PAD[27] = din_7__shared_input[0];

// ----- Blif Benchmark input din_8_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[49] -----
	assign gfpga_pad_GPIO_PAD[49] = din_8__shared_input[0];

// ----- Blif Benchmark input din_9_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[79] -----
	assign gfpga_pad_GPIO_PAD[79] = din_9__shared_input[0];

// ----- Blif Benchmark input din_10_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[14] -----
	assign gfpga_pad_GPIO_PAD[14] = din_10__shared_input[0];

// ----- Blif Benchmark input din_11_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[74] -----
	assign gfpga_pad_GPIO_PAD[74] = din_11__shared_input[0];

// ----- Blif Benchmark input din_12_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[53] -----
	assign gfpga_pad_GPIO_PAD[53] = din_12__shared_input[0];

// ----- Blif Benchmark input din_13_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[75] -----
	assign gfpga_pad_GPIO_PAD[75] = din_13__shared_input[0];

// ----- Blif Benchmark input din_14_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[72] -----
	assign gfpga_pad_GPIO_PAD[72] = din_14__shared_input[0];

// ----- Blif Benchmark input din_15_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[8] -----
	assign gfpga_pad_GPIO_PAD[8] = din_15__shared_input[0];

// ----- Blif Benchmark output dout_0_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[30] -----
	assign dout_0__fpga[0] = gfpga_pad_GPIO_PAD[30];

// ----- Blif Benchmark output dout_1_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[51] -----
	assign dout_1__fpga[0] = gfpga_pad_GPIO_PAD[51];

// ----- Blif Benchmark output dout_2_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[5] -----
	assign dout_2__fpga[0] = gfpga_pad_GPIO_PAD[5];

// ----- Blif Benchmark output dout_3_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[45] -----
	assign dout_3__fpga[0] = gfpga_pad_GPIO_PAD[45];

// ----- Blif Benchmark output dout_4_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[10] -----
	assign dout_4__fpga[0] = gfpga_pad_GPIO_PAD[10];

// ----- Blif Benchmark output dout_5_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[43] -----
	assign dout_5__fpga[0] = gfpga_pad_GPIO_PAD[43];

// ----- Blif Benchmark output dout_6_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[23] -----
	assign dout_6__fpga[0] = gfpga_pad_GPIO_PAD[23];

// ----- Blif Benchmark output dout_7_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[77] -----
	assign dout_7__fpga[0] = gfpga_pad_GPIO_PAD[77];

// ----- Blif Benchmark output dout_8_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[62] -----
	assign dout_8__fpga[0] = gfpga_pad_GPIO_PAD[62];

// ----- Blif Benchmark output dout_9_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[25] -----
	assign dout_9__fpga[0] = gfpga_pad_GPIO_PAD[25];

// ----- Blif Benchmark output dout_10_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[7] -----
	assign dout_10__fpga[0] = gfpga_pad_GPIO_PAD[7];

// ----- Blif Benchmark output dout_11_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[13] -----
	assign dout_11__fpga[0] = gfpga_pad_GPIO_PAD[13];

// ----- Blif Benchmark output dout_12_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[59] -----
	assign dout_12__fpga[0] = gfpga_pad_GPIO_PAD[59];

// ----- Blif Benchmark output dout_13_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[9] -----
	assign dout_13__fpga[0] = gfpga_pad_GPIO_PAD[9];

// ----- Blif Benchmark output dout_14_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[12] -----
	assign dout_14__fpga[0] = gfpga_pad_GPIO_PAD[12];

// ----- Blif Benchmark output dout_15_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[76] -----
	assign dout_15__fpga[0] = gfpga_pad_GPIO_PAD[76];
