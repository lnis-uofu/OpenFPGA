...
// ----- Blif Benchmark input wen is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[9] -----
	assign gfpga_pad_GPIO_PAD[9] = wen_shared_input[0];

// ----- Blif Benchmark input ren is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[13] -----
	assign gfpga_pad_GPIO_PAD[13] = ren_shared_input[0];

// ----- Blif Benchmark input waddr_0_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[66] -----
	assign gfpga_pad_GPIO_PAD[66] = waddr_0__shared_input[0];

// ----- Blif Benchmark input waddr_1_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[51] -----
	assign gfpga_pad_GPIO_PAD[51] = waddr_1__shared_input[0];

// ----- Blif Benchmark input waddr_2_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[8] -----
	assign gfpga_pad_GPIO_PAD[8] = waddr_2__shared_input[0];

// ----- Blif Benchmark input raddr_0_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[55] -----
	assign gfpga_pad_GPIO_PAD[55] = raddr_0__shared_input[0];

// ----- Blif Benchmark input raddr_1_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[12] -----
	assign gfpga_pad_GPIO_PAD[12] = raddr_1__shared_input[0];

// ----- Blif Benchmark input raddr_2_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[71] -----
	assign gfpga_pad_GPIO_PAD[71] = raddr_2__shared_input[0];

// ----- Blif Benchmark input din_0_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[52] -----
	assign gfpga_pad_GPIO_PAD[52] = din_0__shared_input[0];

// ----- Blif Benchmark input din_1_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[65] -----
	assign gfpga_pad_GPIO_PAD[65] = din_1__shared_input[0];

// ----- Blif Benchmark input din_2_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[49] -----
	assign gfpga_pad_GPIO_PAD[49] = din_2__shared_input[0];

// ----- Blif Benchmark input din_3_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[10] -----
	assign gfpga_pad_GPIO_PAD[10] = din_3__shared_input[0];

// ----- Blif Benchmark input din_4_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[69] -----
	assign gfpga_pad_GPIO_PAD[69] = din_4__shared_input[0];

// ----- Blif Benchmark input din_5_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[70] -----
	assign gfpga_pad_GPIO_PAD[70] = din_5__shared_input[0];

// ----- Blif Benchmark input din_6_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[54] -----
	assign gfpga_pad_GPIO_PAD[54] = din_6__shared_input[0];

// ----- Blif Benchmark input din_7_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[14] -----
	assign gfpga_pad_GPIO_PAD[14] = din_7__shared_input[0];

// ----- Blif Benchmark input din_8_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[15] -----
	assign gfpga_pad_GPIO_PAD[15] = din_8__shared_input[0];

// ----- Blif Benchmark input din_9_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[37] -----
	assign gfpga_pad_GPIO_PAD[37] = din_9__shared_input[0];

// ----- Blif Benchmark input din_10_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[50] -----
	assign gfpga_pad_GPIO_PAD[50] = din_10__shared_input[0];

// ----- Blif Benchmark input din_11_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[64] -----
	assign gfpga_pad_GPIO_PAD[64] = din_11__shared_input[0];

// ----- Blif Benchmark input din_12_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[67] -----
	assign gfpga_pad_GPIO_PAD[67] = din_12__shared_input[0];

// ----- Blif Benchmark input din_13_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[68] -----
	assign gfpga_pad_GPIO_PAD[68] = din_13__shared_input[0];

// ----- Blif Benchmark input din_14_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[48] -----
	assign gfpga_pad_GPIO_PAD[48] = din_14__shared_input[0];
...
// ----- Blif Benchmark output dout_0_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[58] -----
	assign dout_0__fpga[0] = gfpga_pad_GPIO_PAD[58];

// ----- Blif Benchmark output dout_1_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[62] -----
	assign dout_1__fpga[0] = gfpga_pad_GPIO_PAD[62];

// ----- Blif Benchmark output dout_2_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[57] -----
	assign dout_2__fpga[0] = gfpga_pad_GPIO_PAD[57];

// ----- Blif Benchmark output dout_3_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[43] -----
	assign dout_3__fpga[0] = gfpga_pad_GPIO_PAD[43];

// ----- Blif Benchmark output dout_4_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[56] -----
	assign dout_4__fpga[0] = gfpga_pad_GPIO_PAD[56];

// ----- Blif Benchmark output dout_5_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[44] -----
	assign dout_5__fpga[0] = gfpga_pad_GPIO_PAD[44];

// ----- Blif Benchmark output dout_6_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[61] -----
	assign dout_6__fpga[0] = gfpga_pad_GPIO_PAD[61];

// ----- Blif Benchmark output dout_7_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[41] -----
	assign dout_7__fpga[0] = gfpga_pad_GPIO_PAD[41];

// ----- Blif Benchmark output dout_8_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[60] -----
	assign dout_8__fpga[0] = gfpga_pad_GPIO_PAD[60];

// ----- Blif Benchmark output dout_9_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[63] -----
	assign dout_9__fpga[0] = gfpga_pad_GPIO_PAD[63];

// ----- Blif Benchmark output dout_10_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[47] -----
	assign dout_10__fpga[0] = gfpga_pad_GPIO_PAD[47];

// ----- Blif Benchmark output dout_11_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[46] -----
	assign dout_11__fpga[0] = gfpga_pad_GPIO_PAD[46];

// ----- Blif Benchmark output dout_12_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[42] -----
	assign dout_12__fpga[0] = gfpga_pad_GPIO_PAD[42];

// ----- Blif Benchmark output dout_13_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[45] -----
	assign dout_13__fpga[0] = gfpga_pad_GPIO_PAD[45];

// ----- Blif Benchmark output dout_14_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[40] -----
	assign dout_14__fpga[0] = gfpga_pad_GPIO_PAD[40];

// ----- Blif Benchmark output dout_15_ is mapped to FPGA IOPAD gfpga_pad_GPIO_PAD[59] -----
	assign dout_15__fpga[0] = gfpga_pad_GPIO_PAD[59];
...
// ----- Input Stimulus -------
// ----- Adapted from dpram_8x16_preload_tb.v Step 2/Step 3 pattern: -----
...
// ----- KEY TIMING: the checker skips the FIRST negedge clk after __config_all_done__ (sim_start -----
// ----- handshake) and compares from the SECOND negedge. ren/raddr must therefore be asserted -----
// ----- IMMEDIATELY when __config_all_done__ goes high, before any negedge, so they are stable -----
// ----- a full cycle before the checker's first real compare. -----
	wire [0:15] dout_fpga_bus = {dout_15__fpga, dout_14__fpga, dout_13__fpga, dout_12__fpga,
...
initial begin
	...
	// ---- Step 2: Read back all preloaded values ----
	@(negedge clk[0]);
	...
	{din_15__shared_input, din_14__shared_input, din_13__shared_input, din_12__shared_input,
	 ...
	 din_3__shared_input,  din_2__shared_input,  din_1__shared_input,  din_0__shared_input} = 16'hBEEF;
