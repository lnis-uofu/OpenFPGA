...
// ----- Verilog module for mux_2level_tapbuf_size33 -----
module mux_2level_tapbuf_size33(in,
                                sram,
                                sram_inv,
                                out);
//----- INPUT PORTS -----
...
// ----- END Local output short connections -----
	...
	mux_2level_tapbuf_basis_input6_mem6 mux_l2_in_0_ (
		.in({mux_2level_tapbuf_basis_input4_mem4_0_out, mux_2level_tapbuf_basis_input6_mem6_4_out, mux_2level_tapbuf_basis_input6_mem6_3_out, mux_2level_tapbuf_basis_input6_mem6_2_out, mux_2level_tapbuf_basis_input6_mem6_1_out, mux_2level_tapbuf_basis_input6_mem6_0_out}),
	...
	mux_2level_tapbuf_basis_input4_mem4 mux_l1_in_5_ (
		.in({const1_0_const1, INVTX1_32_out, INVTX1_31_out, INVTX1_30_out}),
		.mem({sram[3], sram[2], sram[1], sram[0]}),
		.mem_inv({sram_inv[3], sram_inv[2], sram_inv[1], sram_inv[0]}),
		.out(mux_2level_tapbuf_basis_input4_mem4_0_out));

endmodule
// ----- END Verilog module for mux_2level_tapbuf_size33 -----
