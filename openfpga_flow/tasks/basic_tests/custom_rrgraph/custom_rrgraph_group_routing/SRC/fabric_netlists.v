...
`include "${OPENFPGA_PATH}/openfpga_flow/openfpga_cell_library/verilog/inv.v"
`include "${OPENFPGA_PATH}/openfpga_flow/openfpga_cell_library/verilog/buf4.v"
`include "${OPENFPGA_PATH}/openfpga_flow/openfpga_cell_library/verilog/mux2.v"
