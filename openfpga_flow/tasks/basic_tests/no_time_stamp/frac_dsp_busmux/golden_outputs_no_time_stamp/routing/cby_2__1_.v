...
module cby_2__1_(pReset,
                 ...
                 left_grid_right_width_0_height_0_subtile_0__pin_d_in_4_);
//----- GLOBAL PORTS -----
input [0:0] pReset;
//----- INPUT PORTS -----
...
//----- OUTPUT PORTS -----
output [0:0] left_grid_right_width_0_height_0_subtile_0__pin_d_in_4_;
...
// ----- END Local output short connections -----
	...
	mux_2level_tapbuf_size4_mem mem_left_ipin_0 (
		.pReset(pReset),
		.enable(decoder2to4_0_data_out[0]),
		.address(address[0:2]),
		.data_in(data_in),
	...
	mux_2level_tapbuf_size4_mem mem_right_ipin_0 (
		.pReset(pReset),
		.enable(decoder2to4_0_data_out[1]),
		.address(address[0:2]),
		.data_in(data_in),
	...
	mux_2level_tapbuf_size4_mem mem_right_ipin_1 (
		.pReset(pReset),
		.enable(decoder2to4_0_data_out[2]),
		.address(address[0:2]),
		.data_in(data_in),
	...
	mux_2level_tapbuf_size2 mux_right_ipin_2 (
		...
		.out(left_grid_right_width_0_height_0_subtile_0__pin_d_in_4_));

	mux_2level_tapbuf_size2_mem mem_right_ipin_2 (
		.pReset(pReset),
		.enable(decoder2to4_0_data_out[3]),
		.address(address[0]),
		.data_in(data_in),
