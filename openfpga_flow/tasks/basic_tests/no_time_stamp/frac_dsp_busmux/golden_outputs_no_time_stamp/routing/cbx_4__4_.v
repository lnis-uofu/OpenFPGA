...
module cbx_4__4_(pReset,
                 ...
                 bottom_grid_top_width_0_height_3_subtile_0__pin_a_3_,
                 bottom_grid_top_width_0_height_3_subtile_0__pin_a_19_,
                 bottom_grid_top_width_0_height_3_subtile_0__pin_b_3_,
                 bottom_grid_top_width_0_height_3_subtile_0__pin_b_19_);
//----- GLOBAL PORTS -----
input [0:0] pReset;
//----- INPUT PORTS -----
...
//----- OUTPUT PORTS -----
output [0:0] bottom_grid_top_width_0_height_3_subtile_0__pin_a_3_;
//----- OUTPUT PORTS -----
output [0:0] bottom_grid_top_width_0_height_3_subtile_0__pin_a_19_;
//----- OUTPUT PORTS -----
output [0:0] bottom_grid_top_width_0_height_3_subtile_0__pin_b_3_;
//----- OUTPUT PORTS -----
output [0:0] bottom_grid_top_width_0_height_3_subtile_0__pin_b_19_;
...
// ----- END Local output short connections -----
	...
	mux_2level_tapbuf_size4 mux_top_ipin_0 (
		...
		.out(bottom_grid_top_width_0_height_3_subtile_0__pin_a_3_));

	mux_2level_tapbuf_size4 mux_top_ipin_2 (
		.in({chanx_left_in[0], chanx_right_in[0], chanx_left_in[5], chanx_right_in[5]}),
		.sram(mux_2level_tapbuf_size4_9_sram[0:5]),
		.sram_inv(mux_2level_tapbuf_size4_9_sram_inv[0:5]),
		.out(bottom_grid_top_width_0_height_3_subtile_0__pin_b_3_));
	...
	mux_2level_tapbuf_size2 mux_top_ipin_1 (
		...
		.out(bottom_grid_top_width_0_height_3_subtile_0__pin_a_19_));

	mux_2level_tapbuf_size2 mux_top_ipin_3 (
		.in({chanx_left_in[1], chanx_right_in[1]}),
		.sram(mux_2level_tapbuf_size2_1_sram[0:1]),
		.sram_inv(mux_2level_tapbuf_size2_1_sram_inv[0:1]),
		.out(bottom_grid_top_width_0_height_3_subtile_0__pin_b_19_));
