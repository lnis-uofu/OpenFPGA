...
// ----- Verilog module for cby_1__0_ -----
module cby_1__0_(pReset,
                 prog_clk,
                 chany_bottom_in,
                 chany_top_in,
                 ccff_head,
...
// ----- END Local output short connections -----
	...
	mux_2level_tapbuf_size2 mux_right_ipin_6 (
		.in({chany_bottom_in[14], chany_top_in[14]}),
		.sram(mux_2level_tapbuf_size2_14_sram[0:1]),
		.sram_inv(mux_2level_tapbuf_size2_14_sram_inv[0:1]),
		.out(left_grid_right_width_0_height_0_subtile_6__pin_outpad_0_));

	mux_2level_tapbuf_size2 mux_right_ipin_7 (
		.in({chany_bottom_in[15], chany_top_in[15]}),
...
// ----- END Verilog module for cby_1__0_ -----
