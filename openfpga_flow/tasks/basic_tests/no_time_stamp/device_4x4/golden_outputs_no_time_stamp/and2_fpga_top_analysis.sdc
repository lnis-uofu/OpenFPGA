...
# Create clock                                    
##################################################
create_clock clk[0] -period 1.715531051e-09 -waveform {0 8.577655253e-10}

##################################################
# Create input and output delays for used I/Os    
##################################################
set_input_delay -clock clk[0] -max 1.715531051e-09 gfpga_pad_GPIO_PAD[38]
set_input_delay -clock clk[0] -max 1.715531051e-09 gfpga_pad_GPIO_PAD[58]
set_output_delay -clock clk[0] -max 1.715531051e-09 gfpga_pad_GPIO_PAD[17]
...
#######################################
# Disable Timing for unused resources in grid[3][5][1]
#######################################
#######################################
# Disable unused pins for pb_graph_node io[0]
#######################################
set_disable_timing grid_io_top_3__5_/logical_tile_io_mode_io__1/io_inpad[0]
#######################################
# Disable unused mux_inputs for pb_graph_node io[0]
#######################################
set_disable_timing grid_io_top_3__5_/logical_tile_io_mode_io__1//direct_interc_0_/in[0]
#######################################
# Disable unused pins for pb_graph_node iopad[0]
#######################################
set_disable_timing grid_io_top_3__5_/logical_tile_io_mode_io__1/logical_tile_io_mode_physical__iopad_0/iopad_inpad[0]
#######################################
