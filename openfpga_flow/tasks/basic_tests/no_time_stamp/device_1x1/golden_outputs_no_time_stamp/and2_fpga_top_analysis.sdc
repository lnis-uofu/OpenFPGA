...
# Create clock                                    
##################################################
create_clock clk[0] -period 1.43426071e-09 -waveform {0 7.171303551e-10}

##################################################
# Create input and output delays for used I/Os    
##################################################
set_input_delay -clock clk[0] -max 1.43426071e-09 gfpga_pad_GPIO_PAD[29]
set_input_delay -clock clk[0] -max 1.43426071e-09 gfpga_pad_GPIO_PAD[31]
set_output_delay -clock clk[0] -max 1.43426071e-09 gfpga_pad_GPIO_PAD[30]
