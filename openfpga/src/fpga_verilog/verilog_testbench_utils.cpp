 ...
 *
 * bus_group is needed to initialize unused HDL bus bits that REF_DUT
 * still concatenates. Those bits are tied to 0 only; they are not
 * $random'd, because there is no corresponding FPGA I/O.
 *******************************************************************/
