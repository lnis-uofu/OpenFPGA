 ...
 * 1. if there are no requirements on constant inputs, mux_size is the actual
 *one
 ...
 * for MUXGraphs which is a generic representation without labelling datapath
 *inputs
 *************************************************/
 ...
 *************************************************/
enum e_circuit_model_structure find_mux_implementation_structure(
  ...
  if (2 == mux_size) {
    ...
    if (CIRCUIT_MODEL_DESIGN_CMOS ==
        circuit_lib.design_tech_type(circuit_model)) {
