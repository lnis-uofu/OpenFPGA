...
/* Unique MIF data buses on this module: union of buses cached on existing
 * mif_children, plus is_mif_data_bus GPIN ports on the module itself.
 * Returns ids scoped to this module. Empty when the module has no MIF data bus.
 */
