...
ShellCommandId add_build_arch_bitstream_command_template(
  ...
  /* Add an option '--eblif' */
  CommandOptionId opt_eblif = shell_cmd.add_option(
    "eblif", false, "Yosys-generated eblif containing memory .param INIT");
  shell_cmd.set_option_require_value(opt_eblif, openfpga::OPT_STRING);
